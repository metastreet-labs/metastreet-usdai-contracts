...
contract DeployTestEnvironment is Deployer {
    function run(
        ...
        QEVRegistry qevRegistry = new QEVRegistry(100, msg.sender);
        ...
        // Set QEV registry's staked USDai
        QEVRegistry(address(qevRegistry_)).setStakedUSDai(address(stakedUSDai));
