    ...
    IUSDaiQueuedDepositor
{
     ...
     */
    struct DepositCaps {
        mapping(uint32 => DepositCap) depositCaps;
    }
    ...
    function depositCapInfo(
        ...
        DepositCap storage depositCap = _getDepositCapsStorage().depositCaps[srcEid];
    ...
    function updateDepositCap(
        ...
        _getDepositCapsStorage().depositCaps[srcEid].cap = depositCap;
        if (resetCounter) {
            _getDepositCapsStorage().depositCaps[srcEid].counter = 0;
        }
