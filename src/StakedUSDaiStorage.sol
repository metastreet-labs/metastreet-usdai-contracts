...
abstract contract StakedUSDaiStorage {
     ...
     */
    uint64 internal immutable _genesisRedemptionTimestamp;
     ...
     */
    constructor(address usdai, address priceOracle, address adminFeeRecipient, uint64 genesisRedemptionTimestamp) {
        _usdai = IUSDai(usdai);
        _priceOracle = IPriceOracle(priceOracle);
        _adminFeeRecipient = adminFeeRecipient;
        _genesisRedemptionTimestamp = genesisRedemptionTimestamp;
    }
