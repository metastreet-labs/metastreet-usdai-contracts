...
contract QEVLogicTest is QEVBaseTest {
    ...
    function test__QueueIntegrity_EmptyQueue_CannotReorderWithoutSettledAuction() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(QEVLogic.InvalidAuctionStatus.selector));
        vm.prank(users.manager);
        stakedUsdai.reorderRedemptions(auctionId, 1);
    }
    ...
    function test__QueueIntegrity_BasicReordering_SingleBidPartialAmount() public {
        ...
        (IStakedUSDai.Redemption memory originalRedemption,) = stakedUsdai.redemption(1);
        (IStakedUSDai.Redemption memory newRedemption,) = stakedUsdai.redemption(2);
    ...
    function test__QueueIntegrity_BasicReordering_MultipleBidsFromSameRedemption() public {
        ...
        vm.prank(users.manager);
        qevRegistry.postBids(auctionId, firstBid);
    }
    ...
    function test__QueueIntegrity_MultipleRedemptions_AllBidsProcessed() public {
        ...
        // Execute reordering
        vm.prank(users.manager);
        stakedUsdai.reorderRedemptions(auctionId, 3);
        ...
        (IStakedUSDai.Redemption memory redemption1,) = stakedUsdai.redemption(1);
        (IStakedUSDai.Redemption memory redemption2,) = stakedUsdai.redemption(2);
        (IStakedUSDai.Redemption memory redemption3,) = stakedUsdai.redemption(3);
    ...
    function test__QueueIntegrity_MultipleRedemptions_MixedBidsAndNonBids() public {
        ...
        // Execute reordering
        vm.prank(users.manager);
        stakedUsdai.reorderRedemptions(auctionId, 2);
    ...
    function test__QueueIntegrity_PartialProcessing_MultipleCallsForSameAuction() public {
        ...
        vm.prank(users.manager);
        stakedUsdai.reorderRedemptions(auctionId, 3); // First 3 bids

        vm.prank(users.manager);
        stakedUsdai.reorderRedemptions(auctionId, 2); // Next 2 bids

        vm.prank(users.manager);
        stakedUsdai.reorderRedemptions(auctionId, 1); // Last bid
    ...
    function test__QueueIntegrity_MultipleAuctions_SequentialAuctionProcessing() public {
        ...
        vm.prank(users.manager);
        stakedUsdai.reorderRedemptions(auction2Id, 2);
    ...
    function test__QueueIntegrity_EdgeCases_BidAmountExceedsRedemptionShares() public {
        ...
        (IStakedUSDai.Redemption memory redemption,) = stakedUsdai.redemption(1);
    ...
    function test__QueueIntegrity_EdgeCases_VaryingRedemptionAmounts() public {
        ...
        // Execute reordering
        vm.prank(users.manager);
        stakedUsdai.reorderRedemptions(auctionId, 5);
    ...
    function test__Integration_ReorderThenService_CorrectProcessingOrder() public {
        ...
        vm.prank(users.manager);
        uint256 amountProcessed = stakedUsdai.serviceRedemptions(25_000 ether);

        // Verify user3's redemption (highest bidder) was serviced first
        (IStakedUSDai.Redemption memory redemption3,) = stakedUsdai.redemption(4);
